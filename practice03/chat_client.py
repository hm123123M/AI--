...
请提供总结："""
    ...
    for attempt in range(max_retries + 1):
        ...
        response, conn, status = send_request_with_timeout(
            ...
            stream=False, timeout=300  # 5分钟超时
        )
...
def main():
    ...
    try:
        while True:
            ...
            print(f"\n\n[耗时: {elapsed_time:.2f}秒] [历史轮数: {count_chat_rounds(history)}] [上下文长度: {calculate_context_length(history)}]\n")
